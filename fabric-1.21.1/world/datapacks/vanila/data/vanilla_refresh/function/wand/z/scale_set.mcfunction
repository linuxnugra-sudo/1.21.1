...
execute store result score entity_scale refresh_storage run attribute @s generic.scale base get 100
...
execute store result entity @s attributes[{id:"minecraft:generic.scale"}].base double 0.01 run scoreboard players get entity_scale refresh_storage
